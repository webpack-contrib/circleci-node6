...
<div align="center">
  ...
  <h1>CircleCI 2.0 NodeJS 6 LTS build container</h1>
  <p>Docker Repository for the WebpackContrib NodeJS 6 test container.<p>
</div>
...
# config.yml
    docker:
      - image: webpackcontrib/circleci-node6
```
...
[tests]: https://circleci.com/gh/webpack-contrib/circleci-node6.svg?style=svg
[tests-url]: https://circleci.com/gh/webpack-contrib/circleci-node6